        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            <label className="flex flex-col gap-1.5">
              <span className="text-xs font-medium text-zinc-500">Name <span className="text-zinc-300">(optional)</span></span>
              <input
                type="text"
                value={name}
            ...
            <label className="flex flex-col gap-1.5">
              <span className="text-xs font-medium text-zinc-500">Password <span className="text-zinc-300">(min. 8 characters)</span></span>
              <input
                type="password"
                value={password}
            ...
            <label className="flex flex-col gap-1.5">
              <span className="text-xs font-medium text-zinc-500">Confirm password</span>
              <input
                type="password"
                value={confirm}
